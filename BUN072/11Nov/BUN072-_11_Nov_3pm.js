(function (window, utils) {
  ...
  function createDesign() {
    ...
    html.innerHTML = ''+
      ...
      '<!----------------------------------D.I.Y. Basic---------------------------------->' +
      '' +
      '<div class="diy_basic_section_bun72">' +
        '<div class="diy_basic_text_bun72"><span>D.I.Y. Basics</span></div>' +
        '<div class="diy_basic_desc_bun72">' +
          '<div class="diy_basic_1_72"><div class="diy_basic_img_sec_bun72"><img src="//cdn.optimizely.com/img/15721220395/9cabc8cdb0054aa9ba5f8befd7bf305f.png" alt="diy_basic_img"/></div><div class="diy_basic_dtl_sec_bun72"><div class="diy_basic_title"><span class="diy_basic_dtl_text_bun72">D.I.Y. Basics and Skills</span></div><div class="diy_basic_subtext"><span class="diy_basic_dtl_subtext_bun72">Get the basics right with our easy-to-follow guides on common power tools.</span></div></div></div>'+
          '<div class="diy_basic_2_72"><div class="diy_basic_img_sec_bun72"><img src="//cdn.optimizely.com/img/15721220395/3ee0f8fd20da480099d30e552f183896.png" alt="diy_basic_topic_img"/></div><div class="diy_basic_dtl_sec_bun72"><div class="diy_basic_title"><span class="diy_basic_dtl_text_bun72">The D.I.Y. beginner\'s toolkit</span></div><div class="diy_basic_subtext"><span class="diy_basic_dtl_subtext_bun72">Keen to start on the D.I.Y. path? Here\'s our pick of the essentials you need for your first toolbox.</span></div></div></div>'+
          '<div class="diy_basic_3_72"><div class="diy_basic_img_sec_bun72"><img src="//cdn.optimizely.com/img/15721220395/190a4bb62361452ba2f03d3063be5918.png" alt="diy_basic_img"/></div><div class="diy_basic_dtl_sec_bun72"><div class="diy_basic_title"><span class="diy_basic_dtl_text_bun72">The D.I.Y. pro toolkit</span></div><div class="diy_basic_subtext"><span class="diy_basic_dtl_subtext_bun72">As your skills-and the range of projects you tackle-grow, it\'s time to invest in some new toys for the toolkit.</span></div></div></div>'+
        '</div>' +
      '</div>' +
      '' +
      '' +
  ...
  function appendHtml(html, device) {
    if (device === 'mobile') {
      ...
      /*var carousel = document.querySelector('.content-layout');
