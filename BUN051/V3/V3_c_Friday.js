(function(window, utils) {
    ...
    function createDesign() {
        ...
        if(!isMobile()){
            ...
            title.innerHTML = '<p>Maximise your D.I.Y. time this weekend</p>';
        }
        ...
        if(!isMobile()){
            ...
            subText.innerHTML = '<span class="free_click_text">Save time with Click & Collect -' + '</br>' + 'order before 4pm today to pick up after 9am tomorrow</span>';
        }
        textSection.appendChild(subText);
      
        var smileChar = document.createElement('div');
        smileChar.className = 'smile_person_b51';
        smileChar.innerHTML = '<img class="smile_person_desktop_img" src="//cdn.optimizely.com/img/15721220395/8a0d8fed881740e09cf7b5127644acc4.png"/>';
    ...
    function appendHtml(html, device) {
        if(days.indexOf(Date().split(" ")[0]) === "Fri"){
            if (device == 'mobile') {
